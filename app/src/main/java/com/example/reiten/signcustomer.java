...
public class signcustomer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signcustomer);phone = findViewById(R.id.editText3);
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(phoneNumber,30L, TimeUnit.SECONDS,this,
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
                    ...
                    public void onCodeAutoRetrievalTimeOut(String s) {
                        ...
                        Toast.makeText(signcustomer.this, "OTP Timeout, Please Re-generate the OTP Again.", Toast.LENGTH_SHORT).show();
                    ...
                    public void onVerificationFailed(FirebaseException e) {
                        Toast.makeText(signcustomer.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        fAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Toast.makeText(signcustomer.this, "Phone Verified."+fAuth.getCurrentUser().getUid(), Toast.LENGTH_SHORT).show();
                    checkUserProfile();
                }else {
                    progressBar.setVisibility(View.GONE);
                    state.setVisibility(View.GONE);
                    Toast.makeText(signcustomer.this, "Can not Verify phone and Create Account.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void checkUserProfile() {
        ...
        docRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(signcustomer.this, "Profile Do Not Exists", Toast.LENGTH_SHORT).show();
            }
        });
    }
}