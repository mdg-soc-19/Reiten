...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onlineRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                //we will remove value form driver tbl when  driver diconnected
        ...
        location_switch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isOnline) {
                ...
                if(isOnline){
                    ...
                    Snackbar.make(mapFragment.getView(),"You are offine", Snackbar.LENGTH_SHORT)
                            .show();
                }
            }
        });
    ...
    //press ctrl + o
    // because we request runtime permission, we need overirde  Onrequespermissionresult method
            ...
            if(location_switch.isChecked()){
                ...
                geoFire.setLocation(FirebaseAuth.getInstance().getCurrentUser().getUid(), new GeoLocation(latitude, longitude), new GeoFire.CompletionListener() {
                    ...
                    public void onComplete(String key, DatabaseError error) {
                        // add marker
                        if(mCurrent != null)
                            mCurrent.remove();//remove allready mareker
